    ...
    dispatch_async(queue, ^{
        ...
        if (runner.error && self.view.superview)
        {
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                UIAlertController* alert = [UIAlertController alertControllerWithTitle:runner.error.localizedDescription message:nil preferredStyle:UIAlertControllerStyleAlert];
